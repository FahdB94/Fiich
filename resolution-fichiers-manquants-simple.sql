-- =====================================================
-- RÉSOLUTION DES FICHIERS MANQUANTS DANS LE STORAGE (VERSION SIMPLIFIÉE)
-- =====================================================
...
-- 3. SUPPRESSION MANUELLE DES DOCUMENTS ORPHELINS
-- =====================================================

-- Supprimer les documents orphelins un par un pour éviter les conflits de triggers
DO $$
DECLARE
    doc_record RECORD;
...
-- 4. Utilisez les fonctions de vérification pour la maintenance
