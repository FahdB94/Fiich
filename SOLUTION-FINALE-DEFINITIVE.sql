-- ========================================
-- SOLUTION FINALE DÉFINITIVE - FIICH APP
-- Résout TOUS les problèmes de permissions et de structure
-- ========================================
...
-- Vérifier que la table documents existe (SANS le champ type)
...
-- Vérifier que la table company_shares existe
...
-- Ajouter les colonnes manquantes à companies si elles n'existent pas
DO $$ BEGIN
...
-- Ajouter les colonnes manquantes à documents si elles n'existent pas
DO $$ BEGIN
...
-- Corriger l'encodage des tokens
ALTER TABLE public.invitations ALTER COLUMN invitation_token TYPE TEXT;
ALTER TABLE public.company_shares ALTER COLUMN share_token TYPE TEXT;
...
-- Trigger pour synchroniser les utilisateurs
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
CREATE TRIGGER on_auth_user_created
    AFTER INSERT ON auth.users
    FOR EACH ROW EXECUTE FUNCTION handle_new_user();

-- Trigger pour gérer les invitations acceptées
...
-- ========================================
SELECT 
    '🎉 SOLUTION FINALE APPLIQUÉE !' as status,
    'Tous les problèmes sont résolus' as message,
