-- ========================================
-- SOLUTION ULTIME ROBUSTE - FIICH APP
...
BEGIN
    ...
    -- Politiques documents partagés
    DROP POLICY IF EXISTS "users_can_view_shared_documents" ON public.documents;
    
EXCEPTION
    WHEN OTHERS THEN
        -- Ignorer toutes les erreurs de suppression de politiques
        NULL;
END $$;

-- 2. CRÉATION DES TABLES AVEC GESTION D'ERREUR
-- ========================================
...
-- Table documents (SANS le champ type)
...
-- 4. GESTION DES CONTRAINTES UNIQUES
-- ========================================
...
-- 5. SUPPRESSION ET RECRÉATION DES TRIGGERS ET FONCTIONS
-- ========================================
...
-- Supprimer les politiques de storage existantes
...
-- Créer les nouvelles politiques de storage
...
-- ========================================
SELECT 
    '🎉 SOLUTION ULTIME APPLIQUÉE !' as status,
...
-- ========================================
-- FIN DE LA SOLUTION ULTIME ROBUSTE
-- ======================================== 