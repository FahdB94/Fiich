-- =====================================================
-- RÉSOLUTION ULTIME DES FICHIERS MANQUANTS DANS LE STORAGE
-- =====================================================

-- 1. MODIFICATION TEMPORAIRE DE LA CONTRAINTE DE CLÉ ÉTRANGÈRE
-- =====================================================

-- Supprimer temporairement la contrainte de clé étrangère

-- Recréer la contrainte avec CASCADE pour permettre la suppression automatique
...
-- Supprimer les documents orphelins (les logs d'audit seront supprimés automatiquement)
...
-- 4. RESTAURATION DE LA CONTRAINTE ORIGINALE
-- =====================================================
...
-- 5. NETTOYAGE DES LOGS D'AUDIT ORPHELINS
-- =====================================================
...
CREATE OR REPLACE FUNCTION cleanup_orphaned_documents_ultime()
RETURNS TABLE(
...
BEGIN
    ...
    FOR doc_record IN
        ...
        WHERE NOT check_file_exists_in_storage(file_path)
    LOOP
        -- Supprimer l'entrée de la base de données (les logs seront supprimés automatiquement)
...
-- 2. Les logs d'audit associés seront supprimés automatiquement
-- 3. Seuls les documents avec fichiers existants resteront
-- 4. La contrainte de clé étrangère sera restaurée
...
-- SELECT * FROM cleanup_orphaned_documents_ultime(); 