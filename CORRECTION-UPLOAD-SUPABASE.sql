-- CORRECTION UPLOAD POUR SUPABASE (VERSION CORRIGÉE)
...
SELECT 
    ...
    name::text as info1,
    public::text as info2,
    file_size_limit::text as info3
FROM storage.buckets 
WHERE name = 'company-files'
...
SELECT 
    ...
    schemaname::text as info1,
    tablename::text as info2,
    rowsecurity::text as info3
FROM pg_tables 
