-- Fonction simplifiée pour récupérer une invitation par token
...
BEGIN
  ...
  SELECT 
    ...
    '' as invited_by_name,  -- Version simplifiée sans métadonnées
    '' as invited_by_first_name  -- Version simplifiée sans métadonnées
...
BEGIN
  IF EXISTS (
    ...
    RAISE NOTICE '✅ Fonction get_invitation_by_token (version simplifiée) créée avec succès';
  ELSE
